    ...
    return (
      <div className="diagnostic-shell grid min-h-[390px] place-items-center" aria-live="polite">
        <div className="text-center">
          ...
          <p className="mt-6 text-sm font-black uppercase tracking-[0.16em] text-hot">Montando seu check-in</p>
          ...
          {CHECKPOINTS.map((step, index) => {
            ...
            return (
              ...
              >
                ...
                <p className={`mb-0 mt-1 text-[10px] font-black sm:text-xs ${active ? "text-ink" : "text-ink/45"}`}>
                  {step.label}
                </p>
              </div>
            );
              ...
              <button
                ...
                className={`group flex w-full items-center gap-4 rounded-2xl border-2 p-4 text-left transition sm:p-5 ${
                  active
                    ...
                    : "border-ink/15 bg-white hover:border-hot/60"
                }`}
              >
